...
%     \node [anchor=center,circle,draw,fill,inner
%     sep=1pt,label={100:$p_1$}] at (p1) {};

%     \node [anchor=center,circle,draw,fill,inner
%     sep=1pt,label={180:$p_2$}] at (p2) {};

%     \node [anchor=center,circle,draw,fill,inner
%     sep=1pt,label={[label distance=0.2cm]-90:$p_3$}] at (p3) {};

%     \node [anchor=center,circle,draw,fill,inner
%     sep=1pt,label={-45:$p_4$}] at (p4) {};

%     \node [anchor=center,circle,draw,fill,inner
%     sep=1pt,label={[label distance=0.1cm]0:$p_5$}] at (p5) {};
